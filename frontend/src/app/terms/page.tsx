                    ...
                    <div className="flex items-start gap-4">
                        ...
                        <div>
                            ...
                            <p className="text-gray-300 text-sm">
                                ...
                                and CoTrader (&quot;Company,&quot; &quot;we,&quot; &quot;us,&quot; or &quot;our&quot;). By accessing or using the CoTrader platform, you acknowledge that you
                ...
                <div className="space-y-12 text-gray-300">
                    ...
                    <section id="section-1">
                        ...
                        <div className="space-y-3 ml-4">
                            <p><strong className="text-white">&quot;Platform&quot;</strong> refers to the CoTrader web application, including all features, APIs, and related services provided at cotrader.ai and its subdomains.</p>
                    ...
                    <section id="section-6" className="p-6 rounded-xl bg-yellow-500/10 border-2 border-yellow-500/30">
                        ...
                        <div className="space-y-4 ml-4">
                            <p>
                                <strong className="text-white">6.1.</strong> COTRADER AND ITS OPERATORS, EMPLOYEES, AGENTS, AND AFFILIATES ARE NOT REGISTERED AS FINANCIAL ADVISORS, BROKER-DEALERS, INVESTMENT ADVISORS, OR ANY OTHER REGULATED FINANCIAL SERVICES PROVIDER IN ANY JURISDICTION.
                            </p>
                    ...
                    <section className="bg-white/5 rounded-xl p-6 border border-white/10">
                        ...
                        <div className="space-y-2 ml-4">
                            ...
                            <p>
                                ...
                                <a href="https://www.cotrader.ai" className="text-indigo-400 hover:text-indigo-300">www.cotrader.ai</a>
                            </p>
                        </div>
                    </section>
                </div>
